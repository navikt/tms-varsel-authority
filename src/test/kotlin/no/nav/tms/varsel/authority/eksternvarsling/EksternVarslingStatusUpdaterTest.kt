...
import no.nav.tms.varsel.authority.sink.AktiverVarselSink
import no.nav.tms.varsel.authority.sink.VarselRepository
import no.nav.tms.varsel.authority.sink.aktiverVarselEvent
import no.nav.tms.varsel.authority.toJson
import no.nav.tms.varsel.authority.varsel.VarselType.BESKJED
import no.nav.tms.varsel.authority.varsel.VarselType.OPPGAVE
...
class EksternVarslingStatusSinkTest {
    ...
    fun `Lagrer ekstern varsling-status`() {
        ...
        dbVarsel?.eksternVarslingStatus?.let {
            ...
            it.eksternVarslingSendt shouldBe true
    ...
    fun `Flere ekstern varsling-statuser oppdaterer basen`() {
        ...
        status.eksternVarslingSendt shouldBe true
